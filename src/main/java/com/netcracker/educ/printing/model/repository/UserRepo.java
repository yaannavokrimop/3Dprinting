...
public interface UserRepo extends JpaRepository<User, UUID> {
    ...
    @Query("SELECT distinct ex from User ex " +
            ...
            "and ex.role = :role")
    Page<User> findAllByParams(@Param(value = "cityList") List<City> cityList, @Param(value = "height") int height, @Param(value = "width") int width,
                                     @Param(value = "length") int length, @Param(value = "role") Role role, Pageable page);
}
